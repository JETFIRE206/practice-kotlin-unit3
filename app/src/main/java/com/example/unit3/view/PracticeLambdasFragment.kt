...
class PracticeLambdasFragment : Fragment(R.layout.fragment_practice_lambdas) {
    ...
    override fun onCreateView(
        ...
        appendText("\nLambda in all its glory:")
        appendText("('val upperCase1: (String) -> String = { str: String -> str.uppercase() }'))")
        ...
        appendText("('val upperCase2: (String) -> String = { str -> str.uppercase() }')")
        ...
        appendText("('val upperCase3 = { str: String -> str.uppercase() }')")
        ...
        appendText("\nType inference inside and outside lambda together IS NOT POSSIBLE.")
        appendText("'val uppercase4 = { str -> str.uppercase() }'")
        appendText("Cannot infer a type for this parameter. Please specify it explicitly")
        ...
        appendText("('val upperCase5: (String) -> String = { it.uppercase() }')")
        ...
        appendText("\nFunction pointers:")
        appendText("('val upperCase6: (String) -> String = String::uppercase')")
